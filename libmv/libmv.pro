...
DEFINES += CERES_HAVE_PTHREAD CERES_NO_SUITESPARSE CERES_NO_CXSPARSE CERES_NO_LAPACK CERES_HAVE_RWLOCK CERES_TR1_MEMORY_HEADER CERES_TR1_SHARED_PTR
...
c++11 {
    DEFINES += CERES_STD_UNORDERED_MAP CERES_TR1_SHARED_PTR
} else {
    DEFINES += CERES_NO_UNORDERED_MAP DCERES_TR1_MEMORY_HEADER
}
